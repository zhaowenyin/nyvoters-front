<template>
  <div class="info">
    ...
    <div class="content">
      ...
      <div v-if="+type === 1">
        &nbsp;&nbsp;根据《选举法》的规定，现将{{data.countyName}}{{data.belongAreaName}}政党、人民团体推荐和选民10人以上联名推荐的{{data.countyName}}{{data.sessionNum}}人民代表大会初步代表候选人名单
      ...
      <div v-if="+type===2">
         &nbsp;&nbsp;根据选举法的规定，现将{{data.belongAreaName}}选区政党、人民团体推荐和选民10人以上
          联名推荐的{{data.countyName}}{{data.sessionNum}}人民代表大会初步代表候选人名单以姓名笔画为序公告如下。请选民依法进行酝酿讨论
          以便协商确定本选区的正式代表候选人。
