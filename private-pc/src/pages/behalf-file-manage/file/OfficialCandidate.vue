<template>
  <div class="info">
    ...
    <div class="content">
      ...
      <div style="width: 100%">
        &nbsp;&nbsp;根据《选举法》的规定，经<d v-if="+type === 3">{{data.countyName}}</d>{{data.belongAreaName}}选民酝酿协商，根据较多数选民意见<d v-if="+type===4">(或经预选)</d>，确定下列人员为{{data.belongAreaName}}{{data.countyName}}第{{data.sessionNum}}届人民代表大会正式代表候选人。
        现以姓名笔画排序公告如下：
