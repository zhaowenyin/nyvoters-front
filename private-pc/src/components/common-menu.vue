  ...
  <div class="menu-wrapper">
    <el-menu
      ...
      <el-submenu index="3">
        ...
        <el-menu-item v-if="power.indexOf('1')>-1" class="item" index="/qual-review">资格审查</el-menu-item>
        <el-menu-item v-if="power.indexOf('1')>-1" class="item" index="/behalf-recommended">代表推荐</el-menu-item>
        <el-menu-item v-if="power.indexOf('1')>-1" class="item" index="/initial-candidate">初步候选人</el-menu-item>
        <el-menu-item v-if="power.indexOf('1')>-1" class="item" index="/official-candidate">正式候选人</el-menu-item>
        <el-menu-item v-if="power.indexOf('1')>-1" class="item" index="/official-behalf">正式代表</el-menu-item>
        <el-menu-item v-if="power.indexOf('1')>-1" class="item" index="/behalf-file">资料管理</el-menu-item>
       ...
       <el-submenu index="5">
        ...
        <el-menu-item v-if="power.indexOf('1')>-1" class="item" index="/region">行政区管理</el-menu-item>
        <el-menu-item v-if="power.indexOf('1')>-1" class="item" index="/basic">基础设置</el-menu-item>
        <el-menu-item v-if="power.indexOf('1')>-1" class="item" index="/file">文件资料管理</el-menu-item>
        <el-menu-item v-if="power.indexOf('1')>-1" class="item" index="/operate">操作日志</el-menu-item>
      </el-submenu>
